...
export default function PrincipalMessage() {
  return (
    <>
      <PageTop title="Principal's Message" crumb="About" bg="./assets/images/academics/senior-classroom-reading.webp" />

      <section id="principal" className="ab_one section-padding">
          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12 col-xs-12">
              <div className="ab_content">
                ...
                <p>
                  In today's world, where children have greater exposure to information and opportunities than ever before, the importance of character and personality development from an early age cannot be overstated.
                </p>
              </div>
            </div>
            <div className="col-lg-6 col-sm-12 col-xs-12">
